  ...
  const pipeline = [
    {
      ...
      tools: ['Pandas', 'NumPy', 'SQL', 'Kafka'],
    },
    {
      layer: 'Processing',
      color: 'border-purple-500/30 bg-purple-500/5',
      textColor: 'text-purple-400',
      tools: ['Hugging Face', 'LangChain', 'QLoRA/PEFT'],
    },
    {
      layer: 'Model Layer',
      color: 'border-orange-500/30 bg-orange-500/5',
      textColor: 'text-orange-400',
      tools: ['PyTorch', 'TensorFlow', 'XGBoost', 'LightGBM'],
    },
    {
      layer: 'Deployment',
      color: 'border-green-500/30 bg-green-500/5',
      textColor: 'text-green-400',
      tools: ['FastAPI', 'Docker', 'AWS ECS', 'GitHub Actions'],
    },
  ];
