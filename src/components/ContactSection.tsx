...
export default function ContactSection() {
  ...
  return (
    <section
      ...
      className="py-24 px-4 md:px-8 xl:px-0 bg-surface dark:bg-main"
    >
          ...
          {contacts.map((contact) => {
            ...
            return (
              <a
                ...
                className="flex items-center p-4 bg-main dark:bg-surface border border-[var(--color-borderCustom)] rounded-btn hover:border-primary/50 group transition-all duration-[var(--duration-hover)] focus-ring"
              >
