...
export const projects: ProjectData[] = [
  {
    ...
    tags: ['Python', 'QLoRA', 'Mistral-7B', 'LLM'],
    githubUrl: 'github.com/Nikhilsh10/MediTune',
    metrics: [
      { label: 'Domain', value: 'Medical QA' },
  ...
  },
  {
    ...
    tags: ['Python', 'Kafka', 'FastAPI', 'Autoencoder'],
    githubUrl: 'github.com/Nikhilsh10/streamsentinel',
    metrics: [
